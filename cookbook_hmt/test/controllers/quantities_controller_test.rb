...
class QuantitiesControllerTest < ActionController::TestCase
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post :create, quantity: { ingredient_id: @quantity.ingredient_id, quantity: @quantity.quantity, recipe_id: @quantity.recipe_id }
    end
  ...
  test "should update quantity" do
    patch :update, id: @quantity, quantity: { ingredient_id: @quantity.ingredient_id, quantity: @quantity.quantity, recipe_id: @quantity.recipe_id }
    assert_redirected_to quantity_path(assigns(:quantity))
  end
